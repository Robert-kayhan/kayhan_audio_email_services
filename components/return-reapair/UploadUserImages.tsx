...
function RepairUserImageModal({ isOpen, onClose, returnId }: any) {
  ...
  const submitData = async () => {
    ...
    // async () => {
      try {
      const res =  await updateRepairReport({
          id: returnId,
          data: { user_received_productImages: formData.beforePhotos },
        }).unwrap();
        console.log(res)
...
export default RepairUserImageModal;
